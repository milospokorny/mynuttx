/****************************************************************************
 * boards/arm/stm32/ares/include/board.h
 *
...
#ifndef __BOARDS_ARM_STM32_ARES_INCLUDE_BOARD_H
#define __BOARDS_ARM_STM32_ARES_INCLUDE_BOARD_H
...
/* PLL source is HSI/2, PLL multiplier is 9: PLL frequency is
 * 4MHz (XTAL) x 12 = 64MHz
 */

#define STM32_CFGR_PLLSRC       0
#define STM32_CFGR_PLLXTPRE     0
#define STM32_CFGR_PLLMUL       RCC_CFGR_PLLMUL_CLKx16
...
/* PWM
 *
 * The Ares has no real on-board PWM devices, but the board can
...
#endif /* __BOARDS_ARM_STM32_ARES_INCLUDE_BOARD_H */
